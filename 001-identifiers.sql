...
create function meta.row_id(schema_name text,relation_name text,pk_column_name text,pk_value text) returns meta.row_id as $_$ select row(schema_name,relation_name,pk_column_name,pk_value)::meta.row_id $_$ immutable language sql;
